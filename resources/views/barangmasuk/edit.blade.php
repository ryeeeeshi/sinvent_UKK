                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update', $barangMasuk->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('qty_masuk') is-invalid @enderror" name="qty_masuk" value="{{ old('qty_masuk', $barangMasuk->qty_masuk) }}" placeholder="Masukkan Quantity">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('barang_id') is-invalid @enderror" name="barang_id" value="{{ old('barang_id', $barangMasuk->barang_id) }}" placeholder="Masukkan Barang Idnya">
